  ...
  return (
    <section id="careers" className="scroll-mt-24 relative py-20 bg-transparent overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="relative overflow-hidden bg-[var(--surface)]/90 border border-[var(--border)] rounded-3xl p-8 md:p-12 shadow-[var(--shadow-ambient)] hover:border-[#00AEEF]/40 transition-all duration-500 group">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-6 z-10">
              ...
              <h2 className="text-3xl md:text-5xl font-extrabold text-[var(--text)] leading-tight">
                ...
                <span className="bg-gradient-to-r from-[#00AEEF] to-emerald-400 bg-clip-text text-transparent">
            ...
            <div className="relative flex flex-col items-center justify-center gap-6 z-10 h-auto md:h-80 py-4">
              <div className="w-20 h-20 flex items-center justify-center">
                <img src="/logo-icon.png" alt="Orian Mark" className="w-16 h-16 object-contain drop-shadow-[0_6px_18px_rgba(0,0,0,0.25)]" />
              </div>
              ...
              <div className="grid grid-cols-3 gap-3 sm:gap-4 w-full max-w-sm">
                {careerStats.map((stat) => (
                  <div
                    ...
                    className="group p-4 bg-[var(--surface-alt)]/90 border border-[var(--border)] rounded-2xl text-center backdrop-blur-md shadow-lg transition-all duration-300 ease-out cursor-default will-change-transform"
                  ...
                  >
                    ...
                    <div className="text-[9px] sm:text-[10px] text-[var(--text-faint)] whitespace-nowrap font-mono mt-1 transition-colors duration-300 group-hover:text-[var(--accent)]">
                      {stat.label}
                    </div>
                  </div>
                ))}
